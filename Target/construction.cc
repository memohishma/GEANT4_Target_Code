...
G4VPhysicalVolume *MyDetectorConstruction::Construct()
{
    ...
    G4double targetZ = (80 / 2.0) *um;     // نصف السُمك (الكلي 150 ميكرومتر)
    ...
    // Target Volume & Visualization (Yellow-Orange, Transparent)
    ...
    G4VisAttributes *targetVis = new G4VisAttributes(G4Colour(1.0, 0.6, 0.0, 0.4)); // 0.4 opacity for transparency
    ...
    // Detector Volume & Visualization (Green, Transparent)
    ...
    G4VisAttributes *detectorVis = new G4VisAttributes(G4Colour(0.0, 1.0, 0.0, 0.4)); // Green with 0.4 opacity
